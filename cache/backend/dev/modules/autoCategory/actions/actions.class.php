...
abstract class autoCategoryActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->jobeet_category = $this->form->getObject();
  }
  ...
  {
    $this->jobeet_category = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->jobeet_category);
  }
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $jobeet_category)));
